...
public interface VxApiDATAStoreConstant {
	 ...
	 * 网关应用通讯传输中获取json中存放主键的属性名
	 */
	static final String AS_APPLICATION_ID_NAME = "\"name\"";
	/**
	 * 网关应用通讯传输中获取json中存放json字符串对象的属性名
	 */
	static final String AS_APPLICATION_CONTENT_NAME = "\"content\"";
	 ...
	 * API通讯传输中获取json中存放主键的属性名
	 */
	static final String AS_API_ID_NAME = "\"name\"";
	/**
	 * API通讯传输中获取json中存放应用网关主键的属性名
	 */
	static final String AS_API_APP_ID_NAME = "\"appName\"";
	/**
	 * API通讯传输中获取json中存放json字符串对象的属性名
	 */
	static final String AS_API_CONTENT_NAME = "\"content\"";
	 ...
	 * 黑名单列表通讯传输中获取json中存放主键的属性名
	 */
	static final String AS_BLACKLIST_ID_NAME = "\"blacklist\"";
	/**
	 * 黑名单列表通讯传输中获取json中存放json字符串对象的属性名
	 */
	static final String AS_BLACKLIST_CONTENT_NAME = "\"content\"";
